...
> **Disclosure:** I wear WHOOP 4.0 and Oura Ring Gen 4 simultaneously, 24/7. Both purchased with my own money. Some links may be affiliate links. All data is from my personal devices over 600+ tracked nights. [Full disclosure →](disclaimers.html#affiliate)
...
1. **No caffeine after 4pm** → +18 minutes average deep sleep
2. **Dinner done 3.5+ hours before bed** → +6 points average Oura sleep score
3. **Near-zero alcohol (once a month max)** → +12% average HRV improvement
...
1. **Deep sleep duration** — Target 1.5+ hours. This is your physical recovery engine.
2. **Resting heart rate** — Lower is better. Track the trend, not individual nights.
3. **HRV** — Higher is better. The most sensitive indicator of overall recovery.
4. **Sleep consistency** — Same bedtime within a 30-minute window. Consistency matters more than total hours.

Everything else — sleep latency, respiratory rate, skin temperature — is supplementary. Get the big four right first.

---

*Track your own sleep: [WHOOP](https://www.whoop.com) · [Oura Ring](https://ouraring.com)*
*See my full protocol: [My Protocol →](protocol.html)*
*Read the alcohol deep dive: [I Reduced Alcohol to Once a Month →](quit-alcohol-biometrics.html)*
